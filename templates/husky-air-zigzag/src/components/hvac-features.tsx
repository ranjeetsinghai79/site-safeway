...
const REASON_ICONS: Record<string, React.ReactElement> = {
  ...
  leaf: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11 20A7 7 0 019.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-9 10z"/><path d="M2 21c0-9 4-13 8-15"/>
    </svg>
  ),
  smile: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mt-14 flex flex-wrap justify-center gap-3">
          {(config.trustBadges ?? []).map(badge => (
            <span
              ...
              style={{
                background: "rgba(11,14,26,0.03)",
                border: "1px solid rgba(11,14,26,0.08)",
                color: "rgba(11,14,26,0.6)",
                letterSpacing: "0.1em",
              }}
            >
              {badge}
